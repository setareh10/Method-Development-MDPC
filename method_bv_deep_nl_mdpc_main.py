...
# -*- coding: utf-8 -*-
"""
Created on Sun May 28 20:03:10 2023
...
from compute_timelagged_mdpc import compute_bv_nonlinear_timelagged_mdpc
...
def main_deep_nonlinear_timelagged_mdpc(cond, roi_y, roi_x, i):
    ...
    gof = compute_bv_deep_nonlinear_timelagged_mdpc(output[0], output[1])
...
if __name__ == "__main__":
    ...
    for s in sbj_ids:
        ...
        Parallel(n_jobs=n_jobs, backend="loky")(
            delayed(main_deep_nonlinear_timelagged_mdpc)(
                cond, roi_y, roi_x, s
            )
